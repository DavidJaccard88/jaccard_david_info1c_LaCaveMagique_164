...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé sur la table "t_cepage_bouteille"
    ...
    try:
        ...
        if request.method == "GET":
            ...
            for i in data_genres:
                genre_val_list_dropdown.append(i['cepage_bouteille'])

            # Aussi possible d'avoir un id numérique et un texte en correspondance
            # genre_val_list_dropdown = [(i["id_cepage_bouteille"], i["cepage_bouteille"]) for i in data_genres]
